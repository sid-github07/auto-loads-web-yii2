...
<?php if (Yii::$app->user->isGuest && !$load->isOpenContacts()): ?>
    <div>
...
<?php elseif (!Yii::$app->user->isGuest && !Yii::$app->user->identity->hasSubscription()): ?>
    <div>
        <div class="text-center not-logged-in-preview">
        ...
        <div class="text-center">
            <a href="<?php echo Url::to(['subscription/', 'lang' => Yii::$app->language]); ?>"
               class="primary-button search-load-sign-in-btn"
            >
...
<?php elseif (Yii::$app->user->isGuest && $load->isOpenContacts()) : ?>
