...
$serviceBought = $user->hasBoughtService($load, \common\models\CreditService::CREDIT_TYPE_LOAD_PREVIEW_VIEW);
?>
...
<?php if ($serviceBought === false): ?>
    ...
    <?php if ($service->credit_cost <= $user->service_credits): ?>
        <div class="modal-form-footer-center text-center">
            <button type="submit" class="buy-preview-service primary-button" data-load="<?php $load->id?>">
        ...
        <?php echo GridView::widget([
            ...
            'columns' => [
                [
                    ...
                    'value' => function (\common\models\LoadPreview $preview) {
