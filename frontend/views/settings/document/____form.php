...
<div class="document-form-container clearfix <?php echo ($showForm ? '' : ' hidden'); ?>">
    ...
    <?php $form = ActiveForm::begin([
        ...
        'action' => ['settings/add-document', 'lang' => Yii::$app->language, 'type' => $type],
        'options' => [
            'enctype' => 'multipart/form-data',
            'class' => 'document-form clearfix',
        ],
    ]); ?>
        ...
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                <?php echo $form->field($companyDocument, $dateAttribute, [
                    'options' => [
                        'class' => 'field-company-document-date',
                    ]
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                <div class="document-submit">
                    <?php echo Html::button(Icon::show('floppy-o', '', Icon::FA) . Yii::t('element', $submitButtonId), [
                        'id' => $submitButtonId,
