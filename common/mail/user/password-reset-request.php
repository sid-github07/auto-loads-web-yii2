                            ...
                            <tbody>
                                ...
                                <tr style="background: #ffffff;">
                                    <td style="
                                        ...
                                        padding-left: 24px;
                                    ">
                                        <?php echo Yii::t('mail', 'USER_PASSWORD_RESET_REQUEST_BODY_1'); ?>
                                        ...
                                        <div style="text-align: center;">
                                            ...
                                            ">
                                                <?php echo Yii::t('mail', 'USER_PASSWORD_RESET_REQUEST_BUTTON'); ?>
                                            </a>
                                        </div>
                                        
                                        <?php echo Yii::t('mail', 'USER_PASSWORD_RESET_REQUEST_BODY_2', [
