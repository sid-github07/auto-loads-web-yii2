                            ...
                            <tbody>
                                ...
                                <tr style="background: #fff;">
                                    <td style="
                                        ...
                                        padding: 24px;
                                    ">
                                        <?php echo Yii::t('mail', 'USER_SIGN_UP_CONFIRMATION_BODY_1'); ?>
                                        ...
                                        <div style="text-align: center;">
                                            <a href="<?php echo $url; ?>"
                                               ...
                                               ">
                                                <?php echo Yii::t('mail', 'USER_SIGN_UP_CONFIRMATION_BUTTON'); ?>
                                            </a>
                                        </div>
                                        
                                        <?php echo Yii::t('mail', 'USER_SIGN_UP_CONFIRMATION_BODY_2', [
