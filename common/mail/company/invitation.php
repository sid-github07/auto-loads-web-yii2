                            ...
                            <tbody>
                                ...
                                <tr style="background: #ffffff;">
                                    <td style="
                                        ...
                                        padding-left: 24px;
                                    ">
                                        <?php echo Yii::t('mail', 'COMPANY_INVITATION_SEND_BODY_1', [
                                        ...
                                        <div style="text-align: center;">
                                            ...
                                            ">
                                                <?php echo Yii::t('mail', 'COMPANY_INVITATION_SEND_BUTTON'); ?>
                                            </a>
                                        </div>
                                        
                                        <?php echo Yii::t('mail', 'COMPANY_INVITATION_SEND_BODY_2', [
                                            'companyName' => $companyName,
                                        ]); ?>
                                    </td>
                                </tr>
