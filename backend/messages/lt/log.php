...
return [
    ...
    // Search
    'USER_SEARCHED_FOR_LOAD' => 'Vartotojas ieškojo krovinio:' .
        Html::beginTag('ul') .
            Html::tag('li', 'paieškos spindulys: ' . Html::tag('b', '"{radius} km"')) .
            Html::tag('li', 'pakrovimo vieta: ' . Html::tag('b', '"{loadArea}"')) .
            Html::tag('li', 'iškrovimo vieta: ' . Html::tag('b', '"{unloadArea}"')) .
            Html::tag('li', 'tipas: ' . Html::tag('b', '"{type}"')) .
        Html::endTag('ul'),
    'USER_SEARCHED_FOR_CAR_TRANSPORTER' => 'Vartotojas ieškojo autovežio:' .
        Html::beginTag('ul') .
            Html::tag('li', 'paieškos spindulys: ' . Html::tag('b', '"{radius} km"')) .
            Html::tag('li', 'pakrovimo vieta: ' . Html::tag('b', '"{loadLocation}"')) .
            Html::tag('li', 'iškrovimo vieta: ' . Html::tag('b', '"{unloadLocation}"')) .
        Html::endTag('ul'),
